...
try: 
    ...
    pass
model_filename='models/cnn_classifier-2D-te.hdf5'
log_filename='log/cnn-classifier-2D-te.log'


df_pneumo_2d = pd.read_csv('./balanced-tsv/neumo_dataset_balanced_0.tsv' , sep="\t" )
...
if is_training:
    ...
    checkpoint1 = keras.callbacks.ModelCheckpoint( model_filename + '-loss', monitor='val_loss', verbose=0, save_best_only=True,  save_weights_only=False, mode='min',  period=1 )
    checkpoint2 = keras.callbacks.ModelCheckpoint( model_filename + '-last', monitor='val_loss', verbose=0, save_best_only=False, save_weights_only=False, mode='auto', period=1 )
    checkpoint3 = keras.callbacks.ModelCheckpoint( model_filename + '-acc', monitor='val_acc', verbose=0, save_best_only=False, save_weights_only=False, mode='auto', period=1 )
